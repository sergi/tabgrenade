  ...
  function getItem(key, callback) {
    withStore('readonly', function getItemBody(store) {
      ...
      req.onerror = function getItemOnError() {
        callback('Error in asyncStorage.getItem(): ', req.error.name);
      };
    });
  }
  ...
  function setItem(key, value, callback) {
    withStore('readwrite', function setItemBody(store) {
      ...
      req.onerror = function setItemOnError() {
        callback('Error in asyncStorage.setItem(): ' + req.error.name);
      };
    });
  }
  ...
  function removeItem(key, callback) {
    withStore('readwrite', function removeItemBody(store) {
      ...
      req.onerror = function removeItemOnError() {
        callback('Error in asyncStorage.removeItem(): ' + req.error.name);
      };
    });
  }
  ...
  function clear(callback) {
    withStore('readwrite', function clearBody(store) {
      ...
      req.onerror = function clearOnError() {
        callback('Error in asyncStorage.clear(): ', req.error.name);
      };
    });
  }
  ...
  function length(callback) {
    withStore('readonly', function lengthBody(store) {
      ...
      req.onerror = function lengthOnError() {
        callback('Error in asyncStorage.length(): ', req.error.name);
      };
    });
  }
  ...
  function key(n, callback) {
    ...
    withStore('readonly', function keyBody(store) {
      ...
      req.onerror = function keyOnError() {
        callback('Error in asyncStorage.key(): ' + req.error.name);
      };
    });
  }
